<template>
  <div>
    <div class="button-group">
      <button :class="{ active: currentTab === 'control' }" @click="currentTab = 'control'">遥控型号汇聚</button>
      <button :class="{ active: currentTab === 'manufacturer' }" @click="currentTab = 'manufacturer'">按厂商型号</button>
    </div>
    <div v-if="currentTab === 'control'">
      <el-table :data="responseData" :key="responseData.ID" border style="margin-top:10px; overflow:auto; max-height:800px;">
