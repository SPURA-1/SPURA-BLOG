...
export default {
  mounted() {
    ...
    const notes = this.$el.querySelectorAll(".note");
    ...
    const green = style.getPropertyValue("#a5ea9b");
    const pink = style.getPropertyValue("#ff61d8");
    const blue = style.getPropertyValue("#569cfa");
    const orange = style.getPropertyValue("#ffcc81");
    const cyan = style.getPropertyValue("#7ed1e2");
